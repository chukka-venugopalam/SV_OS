...
_Cross-reference: [LEARNING_ENGINE.md](LEARNING_ENGINE.md), [COGNITIVE_MODEL.md](COGNITIVE_MODEL.md), [LEARNING_PATH_ENGINE.md](LEARNING_PATH_ENGINE.md) (see MasteryScorer there for the simpler operational model; this document defines the richer conceptual model), [RECOMMENDATION_ENGINE.md](../Knowledge/RECOMMENDATION_ENGINE.md)_
