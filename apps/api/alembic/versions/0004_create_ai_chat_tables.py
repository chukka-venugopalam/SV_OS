...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('title', sa.String(300), nullable=False, server_default=sa.text("'New Conversation'")),
    ...
    op.create_table(
        'chat_messages',
        sa.Column('id', PG_UUID(as_uuid=True), primary_key=True, server_default=sa.text('gen_random_uuid()')),
        sa.Column('session_id', PG_UUID(as_uuid=True), sa.ForeignKey('chat_sessions.id', ondelete='CASCADE'), nullable=False, index=True),
    ...
    op.create_table(
        ...
        sa.Column('explanation_style', sa.String(50), nullable=False, server_default=sa.text("'balanced'")),
        ...
        sa.Column('auto_generate_titles', sa.Boolean, nullable=False, server_default=sa.text('true')),
    ...
    op.create_table(
        ...
        sa.Column('difficulty', sa.String(20), nullable=False, server_default=sa.text("'intermediate'")),
