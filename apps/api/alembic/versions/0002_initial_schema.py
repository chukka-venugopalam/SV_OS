...
def _create_users() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'role',
            postgresql.ENUM('learner', 'admin', name='user_role_enum', create_type=False),
            nullable=False,
...
def _create_knowledge_nodes() -> None:
    ...
    op.create_table(
        ...
        sa.Column('color', sa.String(7), nullable=True, comment='Hex colour code for UI display'),
        sa.Column(
            'metadata',
            postgresql.JSONB,
            nullable=False,
    ...
    op.create_index(
        'ix_knowledge_nodes_search_vector',
        'knowledge_nodes',
        ['search_vector'],
    ...
    op.create_index('ix_knowledge_nodes_difficulty', 'knowledge_nodes', ['difficulty'])
    # Index on is_published — most queries filter for published nodes.
    op.create_index('ix_knowledge_nodes_is_published', 'knowledge_nodes', ['is_published'])
    # Index on created_at — supports "recently added" queries.
    op.create_index(
        'ix_knowledge_nodes_created_at',
        'knowledge_nodes',
        ['created_at'],
...
def _create_node_tags() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('node_id', 'tag_id', name='uq_node_tags_node_tag'),
    )
...
def _create_skills() -> None:
    ...
    op.create_table(
        ...
        sa.Column('name', sa.String(200), unique=True, nullable=False, comment='Unique skill name'),
        sa.Column('description', sa.Text, nullable=True, comment='Short description of the skill'),
        sa.Column(
            'category',
            sa.String(100),
            nullable=True,
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.ENUM(
                ...
                'specialization',
                'alternative',
                name='skill_relationship_type_enum',
                create_type=False,
            ),
            nullable=False,
...
def _create_careers() -> None:
    ...
    op.create_table(
        ...
        sa.Column('title', sa.String(300), nullable=False, comment='Human-readable career title'),
        sa.Column(
            'description',
            sa.Text,
            nullable=False,
        ...
        sa.Column(
            ...
            nullable=False,
            server_default=sa.text("'growing'"),
        ...
        sa.Column('icon', sa.String(50), nullable=True, comment='Icon identifier for UI display'),
        sa.Column('color', sa.String(7), nullable=True, comment='Hex colour for UI display'),
        sa.Column(
            'metadata',
            postgresql.JSONB,
            nullable=False,
...
def _create_career_requirements() -> None:
    ...
    op.create_index('ix_career_requirements_node_id', 'career_requirements', ['node_id'])
...
def _create_projects() -> None:
    ...
    op.create_table(
        ...
        sa.Column('title', sa.String(300), nullable=False, comment='Human-readable project title'),
        sa.Column('description', sa.Text, nullable=False, comment='Project description and goals'),
        sa.Column(
            'difficulty',
            postgresql.ENUM(
                'beginner',
...
def _create_project_requirements() -> None:
    ...
    op.create_index('ix_project_requirements_node_id', 'project_requirements', ['node_id'])
...
def _create_learning_resources() -> None:
    ...
    op.create_table(
        ...
        sa.Column('title', sa.String(300), nullable=False, comment='Resource title'),
        sa.Column('url', sa.Text, nullable=False, comment='URL to access the resource'),
        sa.Column(
            'resource_type',
            postgresql.ENUM(
                'video',
    ...
    op.create_index('ix_learning_resources_node_id', 'learning_resources', ['node_id'])
...
def _create_learning_paths() -> None:
    ...
    op.create_index('ix_learning_paths_is_published', 'learning_paths', ['is_published'])
...
def _create_learning_sessions() -> None:
    ...
    op.create_table(
        ...
        sa.Column('notes', sa.Text, nullable=True, comment='User notes taken during the session'),
        sa.Column(
            'created_at',
            sa.DateTime(timezone=True),
            nullable=False,
...
def _create_user_progress() -> None:
    ...
    op.create_table(
        ...
        sa.Column('notes', sa.Text, nullable=True, comment='Personal notes taken by the user'),
        sa.Column(
            'created_at',
            sa.DateTime(timezone=True),
            nullable=False,
        ...
        sa.UniqueConstraint('user_id', 'node_id', name='uq_user_progress_user_node'),
    )
    ...
    op.create_index('ix_user_progress_node_id', 'user_progress', ['node_id'])
...
def _create_bookmarks() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('user_id', 'node_id', name='uq_bookmarks_user_node'),
    )
...
def _create_favorites() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('user_id', 'node_id', name='uq_favorites_user_node'),
    )
...
def _create_search_history() -> None:
    ...
    op.create_table(
        ...
        sa.Column('query', sa.Text, nullable=False, comment='Raw search query text'),
        sa.Column(
            'filters',
            postgresql.JSONB,
            nullable=False,
...
def _create_activity_logs() -> None:
    ...
    op.create_table(
        ...
        sa.Column('entity_type', sa.String(50), nullable=True, comment='Type of entity affected'),
        sa.Column(
            'entity_id',
            postgresql.UUID(as_uuid=True),
            nullable=True,
