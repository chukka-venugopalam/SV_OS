...
class TestObservabilityService:
    ...
    async def test_end_operation_updates_metrics(self):
    ...
    async def test_failed_operation_tracking(self):
    ...
    async def test_cached_operation_tracking(self):
    ...
    async def test_operation_log(self):
    ...
    async def test_ollama_cost_zero(self):
