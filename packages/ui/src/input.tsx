      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            type={type}
            className={cn(
              'focus-visible:ring-primary-500 flex h-10 w-full rounded-md border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-900 placeholder:text-neutral-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-offset-white disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-600 dark:bg-neutral-950 dark:text-neutral-100 dark:placeholder:text-neutral-500 dark:focus-visible:ring-offset-neutral-950',
        ...
        {error && (
          <p id={`${inputId}-error`} className="text-error-500 mt-1 text-sm" role="alert">
            {error}
          </p>
        )}
      </div>
